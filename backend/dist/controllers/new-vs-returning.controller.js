...
class NewVsReturningVisitsController {
    constructor(db) {
        this.db = db;
    }
    ...
    async newVsReturningWeekly(req, res) {
        try {
            ...
            const usersCol = (0, schema_1.Users)(this.db);
            const visitsCol = (0, schema_1.MemberVisits)(this.db);
            const vendorId = "67f773acc9504931fcc411ec";
            const vendorObj = new mongodb_1.ObjectId(vendorId);
...
exports.default = NewVsReturningVisitsController;
